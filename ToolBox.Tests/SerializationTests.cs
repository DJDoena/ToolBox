...
public class SerializationTests
{
    ...
    public void SerializeToUtf8String()
    {
        ...
        {
            Array = Array.Empty<SubDataObject>(),
            List = new()
            {
                new()
                {
        ...
        var xml = XmlSerializer<DataObject>.ToString(dataObject, Encoding.UTF8);
    ...
    public void SerializeToIso8859String()
    {
        ...
        var xml = XmlSerializer<DataObject>.ToString(dataObject, Encoding.GetEncoding("ISO-8859-1"));
